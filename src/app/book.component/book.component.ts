...
@Component({
  ...
  imports: [
    ...
    MatCardModule,
    MatButtonModule,
    RouterModule,BannerCarouselComponent,AuthorSectionComponent,CarouselModule
  ],
  ...
  description:''},
    ...
    { title: 'We Are All Guilty Here',
       author: 'Karin Slaughter',
        image: 'angular/public/guilty.jpg',
         category: 'Thriller',
          rating: 3,
         price: 950,
      discount: 5,
    ...
    { title: 'Fat Kid Rules the World',
       author: 'K.L. Going',
        image: 'angular/public/rules.jpg',
         category: 'Kids',
          rating: 3,
         price: 950,
      discount: 5,
 ...
 categories: Category[] = [];
  ...
  get filteredBooks(): Book[] {
    ...
    return this.books.filter((b) => {
      const matchesCategory = selected ? b.category.trim().toLowerCase() === selected : true;
      const matchesText =
  ...
  // 📖 Only show paginated books (2 rows = 8 books)
  ...
  nextPage() {
    if ((this.currentPage + 1) * this.booksPerPage < this.filteredBooks.length) {
      this.currentPage++;
    }
  }
...
get selfHelpBooks(): Book[] {
  return this.books.filter(b => b.category.toLowerCase() === 'self-help');
}
